...
MinHeap::MinHeap(int default_max_size) {
...
int MinHeap::get_item(int index) {
...
void MinHeap::inorder_print_helper(int idx) {
...
void MinHeap::inorder_print() {
  inorder_print_helper(0);
  std::cout << std::endl;
}

void MinHeap::preorder_print_helper(int idx) {
  if (idx > current_size - 1)
    return;
